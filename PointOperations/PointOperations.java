    ...
    public static void main(String[] args) {
        try {
            BufferedImage bi = ImageIO
                    .read(new File("C:\\Code\\CSC4ST-ImageProcessing\\PointOperations\\GrayImage.PNG"));
            int[][][] inimg = bi2int(bi);
            double[] scalars = { 50, 0, 50 };
            int[][][] outimg = PointOperations.alter(inimg, scalars, OPERATION.ADD);
            BufferedImage bout = int2bi(outimg);
            ImageIO.write(bout, "PNG", new File("C:\\Code\\CSC4ST-ImageProcessing\\PointOperations\\ColorImage.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
